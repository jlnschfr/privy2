...
<template>
  <header
    class="flex items-center justify-between border-b border-neutral-400 bg-neutral-600 px-4vw py-2 transition-borderAndBgColor duration-300 dark:border-neutral-200 dark:bg-neutral-50 md:justify-end md:pl-app"
  >
